...
-include $(QCPATH)/common/anorak/BoardConfigVendor.mk

SECTOOLS_SECURITY_PROFILE := $(QCPATH)/securemsm/security_profiles/halliday_tz_security_profile.xml
...
AB_OTA_UPDATER := true
TARGET_RECOVERY_FSTAB := device/qcom/anorak/recovery.fstab
else
TARGET_RECOVERY_FSTAB := device/qcom/anorak/recovery_non_AB.fstab
...
include device/qcom/wlan/anorak/BoardConfigWlan.mk
endif
else
include device/qcom/wlan/anorak/BoardConfigWlan.mk
endif
